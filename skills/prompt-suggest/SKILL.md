...
## Workflow
1. Classify the task (build / modify / test / debug / review / understand / migrate / document / optimize / automate / design / research / data).
2. Open `references/prompt-library.md` in this skill folder (20+ templates) and pick the 2-4 best matches — never dump the whole library.
