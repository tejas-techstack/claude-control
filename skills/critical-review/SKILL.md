...
2. Map first (repo_map.py/graphify.py for code), then examine against this rubric: correctness, security, data integrity, architecture and coupling, error handling, tests, performance where it matters, docs/onboarding, and (for plans) feasibility and hidden assumptions.
